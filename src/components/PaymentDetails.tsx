      ...
      <div className="w-full max-w-md bg-white rounded-lg p-6 shadow-lg">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex">
              <Input value="6145341522" readOnly className="bg-gray-50" />
              <Button variant="outline" className="ml-2 px-2" onClick={() => {
                navigator.clipboard.writeText("6145341522");
          ...
          <div>
            ...
            <Input value="SULEIMAN GERMAN TAUHEED" readOnly className="bg-gray-50" />
          </div>
